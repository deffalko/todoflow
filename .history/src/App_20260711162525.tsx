    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="flex gap-3 mb-6">
          ...
          <button
            onClick={addTask}
            className="px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-indigo-600 transition shadow-lg hover:shadow-xl flex items-center gap-2 whitespace-nowrap"
          >
